...
/** Paytable tuned via `pnpm simulate -- --spins 500000 --bet 10` toward ~94–96% RTP. */
export const SYMBOLS: Record<PaySymbolId, SymbolDefinition> = {
  bronze: {
    id: "bronze",
    label: "Bronze",
    weight: 120,
    payouts: { 3: 0.24, 4: 0.58, 5: 1.65 },
